...
import 'package:flutter_database/db/database_hepler.dart';
    ...
    return new AlertDialog(
      ...
      content: new SingleChildScrollView(
        child: new Column(
          ...
          children: <Widget>[
            getTextField("Masukkan Nama Depan", teFirstName),
            getTextField("Masukkan Nama Belakang", teLastFirstName),
            getTextField("Masukkan Email", teDOB),
            new GestureDetector(
              onTap: () {
                addRecord(isEdit);
